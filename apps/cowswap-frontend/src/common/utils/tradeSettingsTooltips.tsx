...
export const getNonNativeSlippageTooltip = (params?: { isDynamic?: boolean; isSettingsModal?: boolean }): ReactNode => (
  <>
    {params?.isDynamic ? (
      <>
        <Trans>
          Akora Swap dynamically adjusts your slippage tolerance to ensure your trade executes quickly while still getting
          the best price.
        </Trans>{' '}
      ...
      <>
        <Trans>Akora Swap trades are protected from MEV, so your slippage can't be exploited!</Trans>
      </>
    )}
  </>
)
