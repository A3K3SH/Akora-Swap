    ...
    >
      ...
      <span>
        {token && apyDiff && apyDiff > 0 ? (
          <>
            <Trans>
              Convert your <TokenSymbol token={token} /> LP tokens into Akora AMM pools and earn up to{' '}
        ...
        <Trans>any token into Akora AMM pools to start benefiting from attractive APRs.</Trans>{' '}
