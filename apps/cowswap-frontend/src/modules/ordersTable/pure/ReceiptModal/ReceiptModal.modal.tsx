...
const TOOLTIPS_MSG: Record<string, MessageDescriptor> = {
  ...
  NETWORK_COSTS: msg`Akora Protocol covers the fees and costs by executing your order at a slightly better price than your limit price.`,
  ...
  EXPIRY: msg`If your order has not been filled by this date & time, it will expire. Don't worry - expirations and order placement are free on Akora Swap!`,
...
const TOOLTIPS_JSX: Record<string, ReactElement> = {
  ...
  ORDER_TYPE: (
    <span>
      <Trans>
        Orders on Akora Swap can either be market orders (which fill at the market price within the slippage tolerance you
