...
const getConfirmModalConfig = (): {
    ...
    <>
      <p>
        <Trans>
          ...
          bad prices, Akora Swap will not execute your TWAP if the price dips below this percentage.
        </Trans>
      </p>
      <p>
        <Trans>
          This percentage only applies to dips; if prices are better than this percentage, Akora Swap will still execute
          your order.
        </Trans>
      </p>
    </>
  ...
  limitPriceTooltip: (
    <Trans>
      If Akora Swap cannot get this price or better (taking into account fees and price protection tolerance), your TWAP
      will not execute. Akora Swap will <strong>always</strong> improve on this price if possible.
    </Trans>
  ),
