          ...
          {cowContractAddress && (
            <Card>
              <BalanceDisplay titleSize={26}>
                <img src={CowImage} alt={t`Akora Balance`} height="80" width="80" />
                <span>
                  <i>
                    <Trans>Available Akora balance</Trans>
                  </i>
                  <b>
                    {!isProviderNetworkUnsupported && (
                      <TokenAmount amount={cowBalance} defaultValue="0" tokenSymbol={{ ...cowToken, symbol: 'Akora' }} />
                    )}
                  </b>
                </span>
              </BalanceDisplay>
