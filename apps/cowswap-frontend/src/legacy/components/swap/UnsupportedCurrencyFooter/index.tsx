...
const DEFAULT_DETAILS_TEXT: React.ReactNode = (
  <div>
    <Trans>
      Akora Swap does not support all tokens. Some tokens implement similar, but logically different ERC20 contract
      methods which do not operate optimally with Akora Protocol.
      <p>
