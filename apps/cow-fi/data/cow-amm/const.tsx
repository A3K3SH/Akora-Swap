...
export const QUOTES = [
  ...
  {
    title: `"LVR is the main reason for the current concentration in the block builder market. Akora AMM is not only great for LPs, it's important for Ethereum overall."`,
    description: (
      <>
        <b>- Josojo</b>
        <br />
...
export const COW_AMM_CONTENT = [
  {
    description:
      'Liquidity providers deposit tokens into protected Akora AMM liquidity pools, where traders can access the liquidity',
    bgColor: Color.cowamm_dark_green2,
    textColor: Color.cowamm_light_green,
    image: IMG_COWAMM_LP_1,
  },
  {
    description: 'Solvers bid to rebalance Akora AMM pools whenever there is an arbitrage opportunity',
    bgColor: Color.cowamm_dark_green2,
    textColor: Color.cowamm_light_green,
  ...
  {
    description: 'Akora AMM eliminates LVR by capturing arbitrage value for LPs and shielding it from MEV bots',
    bgColor: Color.cowamm_dark_green2,
    textColor: Color.cowamm_light_green,
...
export const FAQ_DATA = [
  ...
  {
    question: 'What is Akora AMM?',
    answer: `
        Akora AMM is a production-ready implementation of an FM-AMM that supplies liquidity for trades made on CoW Protocol. Solvers compete with each other for the right to trade against the AMM. The winning solver is the one that moves the AMM curves higher.
      `,
  },
  {
    question: 'What is a Akora AMM pool ideal for?',
    answer: `
        Akora AMM pools are optimal for every token pair that is not stable-to-stable. Since volatility dictates the amount of LVR that takes place in any given liquidity pool, Akora AMM pools are most effective for volatile token pairs as LPs are protected from arbitrageurs.
      `,
  },
  {
    question: 'Who can create a Akora AMM pool (and how)?',
    answer: (
      <>
        Anyone can create a Akora AMM pool easily and permissionlessly with the{' '}
        <Link
        ...
        >
          follow these instructions in the Akora AMM docs
        </Link>{' '}
  ...
  {
    question: 'Where can I see existing Akora AMM pools?',
    answer: (
      <>
        Akora AMM pools live on Balancer can be found at{' '}
        <Link
