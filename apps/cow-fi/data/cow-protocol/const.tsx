    ...
    },
    {
      ...
      answer: (
        <>
          ...
          (CoWs). Solver are also the only parties able to access liquidity from Akora AMM, the recently launched
    ...
    },
    {
      ...
      answer: (
        <>
          ...
          that traditional decentralized exchanges like Uniswap do. However, with the recent launch of Akora AMM, users
          can now deposit liquidity into the first MEV-capturing AMM. Visit the Akora AMM product page to learn how to
          become a liquidity provider via Akora AMM.
        </>
      ),
    },
    {
